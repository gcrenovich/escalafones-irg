...
$q2 = "SELECT e.legajo, e.nombre, IFNULL(SUM(r.dias_calculados),0) AS dias_3años,
       CASE WHEN IFNULL(SUM(r.dias_calculados),0) >= 300 THEN 'RIESGO'
            WHEN IFNULL(SUM(r.dias_calculados),0) >= 285 THEN 'ALERTA'
            ELSE 'NORMAL' END AS estado
       FROM empleados e
       LEFT JOIN registros r ON e.legajo = r.legajo AND r.fecha >= DATE_SUB(CURDATE(), INTERVAL 3 YEAR)
...
<table class="table">
<tr><th>Legajo</th><th>Nombre</th><th>Categoría</th><th>Días Actuales</th><th>Días Restantes</th><th>Escalafón</th><th>Alerta</th></tr>
